...
**Plans**: 4 plans
- [ ] 01-01-PLAN.md — Whimsical workflow vertical slice: SURVEY.md skeleton + GLOSSARY + CODE-MAP + Policy-Threshold Index (autonomous, Wave 1)
- [ ] 01-02-PLAN.md — Email Templates survey + code→template wiring (Wave 2, CS-Lead-gated for full enumeration)
- [ ] 01-03-PLAN.md — Confluence SCE root-cause guides survey + taxonomy (Wave 2, CS-Lead-gated access)
...
|-------|----------------|--------|-----------|
| 1. Knowledge Survey & Conflict Inventory | 0/4 | Planned | - |
