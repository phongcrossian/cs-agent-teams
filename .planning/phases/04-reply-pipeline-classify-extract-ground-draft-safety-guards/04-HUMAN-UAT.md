...
note: An automated edit to this file was attempted and correctly BLOCKED by the harness auto-mode classifier as a "safety-contract self-modification not explicitly requested by the user." This edit needs your explicit authorization. Approve and I will update the D-13 section to D-26 (and the D-08 "Commitment language in draft" bullet to "unauthorized commitment / out-of-policy offer").
