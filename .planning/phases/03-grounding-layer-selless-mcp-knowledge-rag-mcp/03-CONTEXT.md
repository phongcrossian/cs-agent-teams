...
- **Selless API** — endpoints, auth, field shapes for order/customer/purchase-history/product/inventory/ticket-history; whether ticket history is exposed (D-05). Noted "scattered, not AI-ready" and unconfirmed — **primary research target** (D-01)
